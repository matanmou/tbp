...
var PickService = /** @class */ (function () {
    ...
    PickService.prototype.getPick = function (id) {
        ...
        this.http.get(this.api + '/' + id).subscribe(function (p) {
            _this.pickToChose(p);
            _this.pgTeams.next(_this.pickedTeams);
            _this.pickBy.next(p.userName);
            _this.pickDate.next(p.date);
            _this.pickName.next(p.name);
    ...
    PickService.prototype.pickToChose = function (p) {
        var _loop_1 = function (i) {
            ...
            if (p[pl] > 0) {
                var indx = void 0;
                indx = this_1.teamService.teams.findIndex(function (t) {
                    return t.id == p[pl];
                });
                var team = this_1.teamService.teams[indx];
...
var ShowPredictComponent = /** @class */ (function () {
    function ShowPredictComponent(pickService, route) {
        ...
        this.pickService = pickService;
        this.route = route;
        this.pickService.pgTeams.subscribe(function (c) { _this.chosenTeams = c; });
    }
    ShowPredictComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.id = params['id'];
            setTimeout(function () { _this.pickService.getPick(_this.id); }, 400);
        });
        setTimeout(function () { _this.getNames(); }, 400);
    };
    ShowPredictComponent.prototype.getNames = function () {
        var _this = this;
        this.pickService.pickName.subscribe(function (p) { _this.pickName = p; });
        this.pickService.pickBy.subscribe(function (p) { _this.pickBy = p; });
        this.pickService.pickDate.subscribe(function (p) { _this.pickDate = p; });
    };
